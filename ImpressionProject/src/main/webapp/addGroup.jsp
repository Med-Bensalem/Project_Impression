                                        ...
                                        <div class="mt-4">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="mb-3 col-md-12">
                                                    ...
                                                    <div class="invalid-feedback">Veuillez saisir un Nom Groupe .</div>
                                                </div>
                                                <!-- Slug -->
                                                ...
                                                <div class="mb-3 col-md-12">
                                                    <label for="Excerpt" class="form-label">Nombre d etudiant</label>
                                                     <input type="text" id="nbetudiants" name="nbetudiants" class="form-control text-dark" placeholder="Nombre Etudiant" required >
